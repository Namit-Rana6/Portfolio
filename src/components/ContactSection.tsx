...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'namit2006rana@gmail.com',
    href: 'mailto:namit2006rana@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 7042840762',
    href: 'https://wa.me/917042840762',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/namit-rana',
    href: 'https://www.linkedin.com/in/namit-rana/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Namit-Rana6',
    href: 'https://github.com/Namit-Rana6',
  },
];
...
const ContactSection = () => {
  return (
    ...
    >
      ...
      <FadeIn y={40}>
        <h2
          className="hero-heading text-center font-black uppercase tracking-tight leading-none mb-4 text-[#D7E2EA]"
      ...
      {/* Contact cards */}
          <div className="mx-auto grid max-w-5xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
